      ...
      <section id="transformation" className="py-20 lg:py-28 bg-white relative">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-3xl overflow-hidden shadow-xl">
            ...
            {/* Headers */}
            <div className="grid grid-cols-1 md:grid-cols-2 bg-slate-900 text-white font-garet font-bold text-base sm:text-lg">
              <div className="p-6 md:p-8 bg-red-950/40 border-b md:border-b-0 md:border-r border-slate-800 flex items-center gap-3">
            ...
            <div className="divide-y divide-slate-200">
              {TRANSFORMATION_DATA.rows.map((row, idx) => (
                <div key={idx} className="grid grid-cols-1 md:grid-cols-2 hover:bg-slate-100/80 transition-colors">
                  
                  {/* Left: Conventional (Red X icon) */}
                  <div className="p-6 md:p-8 flex items-start gap-4 border-b md:border-b-0 md:border-r border-slate-200">
