...
export const FloatingWaCs: React.FC = () => {
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <a
        ...
        className="flex items-center gap-3 bg-emerald-500 hover:bg-emerald-600 text-white font-jakarta font-bold text-xs sm:text-sm px-5 py-3.5 rounded-full shadow-[0_10px_25px_rgba(16,185,129,0.4)] transition-all duration-300 transform hover:scale-105 group border border-white/20"
        title="Klaim Harga Khusus Mitra via WhatsApp"
      >
        ...
        <span className="hidden sm:inline font-garet uppercase tracking-wider">Harga Khusus WA</span>
      </a>
    </div>
  );
};
